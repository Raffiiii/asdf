        const apiKey = 'API-KEY' // apikey you can get it at Raff's ygy
  ...
  case '${prefix}help':
         client.reply(from, '*• BoTv2 •*
👋🏻 Ohayou ${pushname}

• Info Tentang Prefix •
Prefix Dari BoTv2 adalah "#" 

*• Menu Utama Dari BoTv2 •*
...
#igstalk
[Example : #igstalk [Nama Ig] Contoh #igstalk @Raff.Exe_  untuk menstalk ig orang]
...
--->Pertama Bot tidak Akan Pernah Menyimpan Teks,Image,Video,Document,Audio dll Yg Anda kirim Maybe,Ehe

--->Jangan Pernah Mengspam Bot karena itu membuat Bot down ygy

--->Jangan Pernah Video call dan telpon bot atau nomor kalian akan terblock secara otomatis 

<THE POWERD OF BoTv2>', id)
         break
         
     case '${prefix}donasi':
         client.reply(from, '082119629010 telkomsel', id)
         break
...
*Z2HxR*
082119629010 [telkomsel]

Copyright By
==========
Mhankbarbar,YogaSakti,Arugaz,Z2HxR', id)
         break
...
[Example : reply pesan bot dengan kata kata #del fitur ini untuk menghapus pesan bot]', id)
     ...
     case '${prefix}bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ Xyro ]\n\n${msg}`)
            }
